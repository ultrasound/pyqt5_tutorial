...
from PyQt5.QtWidgets import QApplication, \
    QWidget, QPushButton, QToolTip, QMainWindow, QAction, qApp, QDesktopWidget, QLabel, \
    QHBoxLayout, QVBoxLayout, QGridLayout, QLineEdit, QTextEdit, QGroupBox, QComboBox
...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        self.input_mask_cb.addItem('No maks')
        self.input_mask_cb.addItem('Phtone number')
    ...
    def input_mask_changed(self, index):
        if index == 0:
            self.input_make_le.setInputMask('')
        elif index == 1:
