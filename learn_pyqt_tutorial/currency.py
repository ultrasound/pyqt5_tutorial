...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ax.setLimits(xMin=-HISTORIC_DAY_N + 1, xMax=0)
    ...
    def get_or_create_data(self, currency):
    ...
    def redraw(self):
        ...
        tick_step_size = HISTORIC_DAY_N / 6
