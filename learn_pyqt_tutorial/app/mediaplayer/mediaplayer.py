...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, *args, **kwargs):
        ...
        # self.viewer.state.connect(self.toggle_viewer)
        ...
        self.playlistView.customContextMenuRequested.connect(self._context_menu)
    ...
    def _context_menu(self, position):
        idx = self.playlistView.currentIndex()

        menu = QMenu()
        remove_action = menu.addAction("remove")
        action = menu.exec_(self.playlistView.mapToGlobal(position))
