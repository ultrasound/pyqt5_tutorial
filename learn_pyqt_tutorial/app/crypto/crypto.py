...
requests_cache.install_cache('goodforbitcoin')
    ...
    def run(self):
        ...
        try:
            ...
            for n, crypto in enumerate(AVAILABLE_CRYPTO_CURRENCIES, 1):
                ...
                r.raise_for_status()  # 4XX or 5XX 같은 에러를 받으면 에러 발생, 200은 None
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ax.showGrid(x=True, y=True)  # 백그라운드에 바둑판 설정
        ...
        self.ax.setLabel(axis='left', text='Rate')
        ...
        self.currencyList.addItems(AVAILABLE_BASE_CURRENCIES)
