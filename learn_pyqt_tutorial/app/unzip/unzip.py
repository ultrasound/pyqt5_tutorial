...
from PyQt5.QtCore import pyqtSlot, QObject, QRunnable, pyqtSignal, QThreadPool, Qt, QTimer
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setAttribute(Qt.WA_TranslucentBackground)  # 윈도우 백그라운드를 투명하게 만듬
        self.setWindowFlags(Qt.FramelessWindowHint)  # 윈도우 프레임 제거
        ...
        # QLabel에는 mouse press event가 없기 때문에 동적 메소드 형을 만들 QMainWindow 오브젝트에 추가.
